...
-- Link to definition of import function
-- https://github.com/zyedidia/micro/blob/master/cmd/micro/initlua.go#L22
local micro = import("micro")
local config = import("micro/config")
local buffer = import("micro/buffer")

-- Example code copied from https://github.com/NicolaiSoeborg/manipulator-plugin
--
...
-- TODO Function to insert current date at cursor position and key binding
